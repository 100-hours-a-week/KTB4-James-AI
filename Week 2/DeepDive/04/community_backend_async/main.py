...
# DeepDive02 extends latest 2-5 base

from fastapi import Request
from fastapi.responses import JSONResponse
class AIModelUnavailable(Exception):
    pass
@app.exception_handler(AIModelUnavailable)
async def ai_unavailable(req: Request, exc: AIModelUnavailable):
    return JSONResponse(status_code=503, content={'code':'AI_MODEL_UNAVAILABLE','fallback':True})
